...
If NOT WpfWindow("OpenText MyFlight Sample").WpfObject("ORDER DETAILS").Exist Then
	Reporter.ReportEvent micFail, "Change Order - Wrong Screen", "Not on ORDER DETAILS screen. Exiting..."
	ExitAction
End  If

WpfWindow("OpenText MyFlight Sample").WpfComboBox("numOfTicketsCombo").Select a @@ hightlight id_;_1904552888_;_script infofile_;_ZIP::ssf4.xml_;_
WpfWindow("OpenText MyFlight Sample").WpfComboBox("flightClassCombo").Select b @@ hightlight id_;_1955290176_;_script infofile_;_ZIP::ssf8.xml_;_
WpfWindow("OpenText MyFlight Sample").WpfEdit("passengerName").Set c @@ hightlight id_;_1955294928_;_script infofile_;_ZIP::ssf10.xml_;_
...
If WpfWindow("OpenText MyFlight Sample").WpfObject("OrderUpdatedMessage").Exist (4) Then
	WpfWindow("OpenText MyFlight Sample").WpfObject("OrderUpdatedMessage").Output CheckPoint("OrderUpdatedNumber") @@ hightlight id_;_1939452064_;_script infofile_;_ZIP::ssf19.xml_;_
End  If
