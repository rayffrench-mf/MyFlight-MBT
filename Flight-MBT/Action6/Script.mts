...
If NOT WpfWindow("OpenText MyFlight Sample").WpfObject("ORDER DETAILS").Exist Then @@ hightlight id_;_1905290200_;_script infofile_;_ZIP::ssf7.xml_;_
...
If WpfWindow("OpenText MyFlight Sample").WpfButton("WpfButton").GetROProperty("enabled") = "True" Then @@ hightlight id_;_2058186184_;_script infofile_;_ZIP::ssf1.xml_;_
	WpfWindow("OpenText MyFlight Sample").WpfButton("WpfButton").Click
	WpfWindow("OpenText MyFlight Sample").Dialog("Notification").WinButton("Yes").Click @@ hightlight id_;_2753606_;_script infofile_;_ZIP::ssf2.xml_;_
	...
	If WpfWindow("OpenText MyFlight Sample").WpfObject("OrderDeletedMessage").Exist (4) Then
		WpfWindow("OpenText MyFlight Sample").WpfObject("OrderDeletedMessage").Output CheckPoint("OrderDeletedNumber") @@ hightlight id_;_2137223792_;_script infofile_;_ZIP::ssf3.xml_;_
	End  If
Else
